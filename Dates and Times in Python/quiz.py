...
class Quiz:
    ...
    def __init__(self):
        ...
        # generate random questions with numbers from 1 to 10
        number_of_questions = int(input("How many questions do you want to work on? "))
        print("Please specify a number range, i.e. low number to high number.")
    ...
    def ask(self, question):
        ...
        print("{} took {} seconds to answer.".format(question.text, question_time.seconds))
